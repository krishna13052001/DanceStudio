...
<head>
<meta charset="utf-8">
<title>Choreographer Login Page</title>
...
<div class="menu-bar">
	...
	<li  class="active"><a href="#"><i class="fa fa-sign-in"></i>Sign In</a>
		...
		<div class="box">
		<h2>Choreographer Login</h2>
		<form method="POST" action="loginchor.php">
	<div class="inputBox">
			...
			<p><a class="one" href="Chor Reg.php" target="_blank">New Choreographer Click Here...</a></p>
		</form>
		<?php
