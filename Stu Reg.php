...
<div class="box">
            ...
            <form action="Stu Reg.php" method="post">
                <div class="inputBox">
                    <input type="text" name="txtname" id="textfield" required="" autocomplete="off">
                ...
                <p class="gender">
                    ...
                    <input type="date" name="txtdob" class="genm" autocomplete="off">
                </p>
                <br>
                <div class="inputBox">
                    <input type="text" name="txtad" id="textarea" required="" autocomplete="off">
                    <label>Address</label>
                </div>
                <div class="inputBox">
                ...
                <div class="inputBox">
                    <input type="email" name="txtmail" id="email" required="" autocomplete="off">
                    <label>E-Mail</label>
                </div>
                <div class="inputBox">
                    <input type="password" name="txtpd" id="password" required="" autocomplete="off">
                ...
                <div class="inputBox">
                    <input type="text" name="txtawards" id="textfield4" required="" autocomplete="off">
...
if($txtpd === $txtcpd ){
    $sql=$insertdata->studentreg($txtname,$rdogender,$txtdob,$txtad,$txtmn,$txtmail,$txtpd,$combodance,$txtawards);
    if($sql)
    {
