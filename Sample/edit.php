...
if(isset($_POST['update'])){
	...
	$insert = "UPDATE tbl_chor_reg set username = '$fn', email_id = '$ln' where md5(id) = '$ID'";
			...
			<div id="content">
				...
				<table align="center">
					<tr>
						...
						<tr>
							<td>Last Name: <input type="text" name="lname"  value="<?php echo $row['email_id'];?>" placeholder="Type Last Name here.." required></td>
						</tr>
						<tr>
