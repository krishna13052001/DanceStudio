...
<!--							<form action="pending_ballet.php" method="POST">-->
								...
								<?php 
                                    $q=mysqli_query($conn,"select * from request where dance_type='Ballet Dance' and student_name='$name' and status='pending'");
